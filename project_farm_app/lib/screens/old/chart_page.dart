...
class _ChartPageState extends State<ChartPage> {
  ...
  Future loadSensorsData() async{
    final String jsonString = await getJsonFromAssets(widget.uid_data);
        ...
        body: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              final uidData = data?['uid_data']?? '';
              final asset = data?['asset']?? '';// ดึง uid_data ของแต่ละรายการ
              return ListView.builder(
                itemCount: 1, // แสดงสิบกราฟ
              ...
              return Container(); // คืนค่า Container เปล่าๆ ในกรณีที่ไม่มีข้อมูล
            }
