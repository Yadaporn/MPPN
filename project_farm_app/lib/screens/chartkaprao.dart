...
class ChartKaprao extends StatefulWidget {
  const ChartKaprao({super.key});

  @override
  State<ChartKaprao> createState() => _ChartKapraoState();
}

class _ChartKapraoState extends State<ChartKaprao> {
  List val = [
    "value1",
    "value2",
    "value3",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Color(0xFFFFA600),
        title: Text('กราฟแสดงเซนเซอร์ แปลงกะเพรา',
