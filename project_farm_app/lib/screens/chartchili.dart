...
class ChartChili extends StatefulWidget {
  const ChartChili({super.key});

  @override
  State<ChartChili> createState() => _ChartChilState();
}

class _ChartChilState extends State<ChartChili> {
  List val = [
    "value1",
    "value2",
    "value3",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Color(0xFFFFA600),
        title: Text('กราฟแสดงเซนเซอร์ แปลงพริก',
